...
type AdminAPI interface {
	...
	*/
	...
	/*
	AdminGetRunnerBySandboxId Get runner by sandbox ID

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param sandboxId Sandbox ID
	@return AdminAPIAdminGetRunnerBySandboxIdRequest
	*/
	AdminGetRunnerBySandboxId(ctx context.Context, sandboxId string) AdminAPIAdminGetRunnerBySandboxIdRequest

	// AdminGetRunnerBySandboxIdExecute executes the request
	//  @return RunnerFull
	AdminGetRunnerBySandboxIdExecute(r AdminAPIAdminGetRunnerBySandboxIdRequest) (*RunnerFull, *http.Response, error)

	/*
	AdminGetRunnersBySnapshotRef Get runners by snapshot ref

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return AdminAPIAdminGetRunnersBySnapshotRefRequest
	*/
	AdminGetRunnersBySnapshotRef(ctx context.Context) AdminAPIAdminGetRunnersBySnapshotRefRequest

	// AdminGetRunnersBySnapshotRefExecute executes the request
	//  @return []RunnerSnapshotDto
	AdminGetRunnersBySnapshotRefExecute(r AdminAPIAdminGetRunnersBySnapshotRefRequest) ([]RunnerSnapshotDto, *http.Response, error)
...
type AdminAPIAdminGetRunnerBySandboxIdRequest struct {
	ctx context.Context
	ApiService AdminAPI
	sandboxId string
}

func (r AdminAPIAdminGetRunnerBySandboxIdRequest) Execute() (*RunnerFull, *http.Response, error) {
	return r.ApiService.AdminGetRunnerBySandboxIdExecute(r)
}
...
AdminGetRunnerBySandboxId Get runner by sandbox ID
 ...
 @return AdminAPIAdminGetRunnerBySandboxIdRequest
*/
func (a *AdminAPIService) AdminGetRunnerBySandboxId(ctx context.Context, sandboxId string) AdminAPIAdminGetRunnerBySandboxIdRequest {
	return AdminAPIAdminGetRunnerBySandboxIdRequest{
		ApiService: a,
		ctx: ctx,
		sandboxId: sandboxId,
...
// Execute executes the request
//  @return RunnerFull
func (a *AdminAPIService) AdminGetRunnerBySandboxIdExecute(r AdminAPIAdminGetRunnerBySandboxIdRequest) (*RunnerFull, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AdminAPIService.AdminGetRunnerBySandboxId")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type AdminAPIAdminGetRunnersBySnapshotRefRequest struct {
	ctx context.Context
	ApiService AdminAPI
	ref *string
}
...
// Snapshot ref
func (r AdminAPIAdminGetRunnersBySnapshotRefRequest) Ref(ref string) AdminAPIAdminGetRunnersBySnapshotRefRequest {
	r.ref = &ref
	return r
}

func (r AdminAPIAdminGetRunnersBySnapshotRefRequest) Execute() ([]RunnerSnapshotDto, *http.Response, error) {
	return r.ApiService.AdminGetRunnersBySnapshotRefExecute(r)
}
...
AdminGetRunnersBySnapshotRef Get runners by snapshot ref
 ...
 @return AdminAPIAdminGetRunnersBySnapshotRefRequest
*/
func (a *AdminAPIService) AdminGetRunnersBySnapshotRef(ctx context.Context) AdminAPIAdminGetRunnersBySnapshotRefRequest {
	return AdminAPIAdminGetRunnersBySnapshotRefRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []RunnerSnapshotDto
func (a *AdminAPIService) AdminGetRunnersBySnapshotRefExecute(r AdminAPIAdminGetRunnersBySnapshotRefRequest) ([]RunnerSnapshotDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AdminAPIService.AdminGetRunnersBySnapshotRef")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
