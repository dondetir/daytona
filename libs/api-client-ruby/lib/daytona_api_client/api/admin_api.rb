...
module DaytonaApiClient
  class AdminApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [RunnerFull]
    def admin_get_runner_by_sandbox_id(sandbox_id, opts = {})
      data, _status_code, _headers = admin_get_runner_by_sandbox_id_with_http_info(sandbox_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(RunnerFull, Integer, Hash)>] RunnerFull data, response status code and response headers
    def admin_get_runner_by_sandbox_id_with_http_info(sandbox_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AdminApi.admin_get_runner_by_sandbox_id ...'
      end
      # verify the required parameter 'sandbox_id' is set
      if @api_client.config.client_side_validation && sandbox_id.nil?
        fail ArgumentError, "Missing the required parameter 'sandbox_id' when calling AdminApi.admin_get_runner_by_sandbox_id"
      end
      # resource path
      local_var_path = '/admin/runners/by-sandbox/{sandboxId}'.sub('{' + 'sandboxId' + '}', CGI.escape(sandbox_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"AdminApi.admin_get_runner_by_sandbox_id",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AdminApi#admin_get_runner_by_sandbox_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def admin_get_runners_by_snapshot_ref(ref, opts = {})
      data, _status_code, _headers = admin_get_runners_by_snapshot_ref_with_http_info(ref, opts)
      data
    end
    ...
    def admin_get_runners_by_snapshot_ref_with_http_info(ref, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AdminApi.admin_get_runners_by_snapshot_ref ...'
      end
      # verify the required parameter 'ref' is set
      if @api_client.config.client_side_validation && ref.nil?
        fail ArgumentError, "Missing the required parameter 'ref' when calling AdminApi.admin_get_runners_by_snapshot_ref"
      end
      # resource path
      local_var_path = '/admin/runners/by-snapshot-ref'
      ...
      new_options = opts.merge(
        :operation => :"AdminApi.admin_get_runners_by_snapshot_ref",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AdminApi#admin_get_runners_by_snapshot_ref\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
